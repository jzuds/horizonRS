...
- Item stats / attributes / usage
- Item sourcing via shops & drop tables

## Data sources to consider
- [RuneScape:Real-time Prices](https://oldschool.runescape.wiki/w/RuneScape:Real-time_Prices)
- [osrsbox-api](https://github.com/0xNeffarion/osrsbox-api)
